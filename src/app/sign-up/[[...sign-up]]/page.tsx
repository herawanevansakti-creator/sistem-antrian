            ...
            <div className="relative z-10 flex items-center justify-center px-4 py-12 md:py-20">
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-black text-[#0e0e1b] tracking-tight mb-2">Create an account</h1>
                        <p className="text-[#505095] text-sm font-medium">Get started with RecruitFlow today</p>
                    </div>
